      ...
      {!showForgotPassword ? (
          ...
          <div className="flex justify-between items-center">
            <div className="flex flex-col">
              <Link className="text-primary" to={'/register'}>
                Don't has an account? signUp here
              </Link>
              <h1 className="underline text-primary cursor-pointer" onClick={() => setShowForgotPassword(true)}>
                Forgot password?
              </h1>
            </div>
            <button className="py-1 px-5 text-white bg-primary" onClick={loginUser}>
              LOGIN
            </button>
          </div>
        </div>
        ...
        <div className="flex flex-col space-y-5 w-[400px]">
          ...
          <div className="flex flex-col justify-between items-end space-y-5">
            <button className="py-1 px-5 text-white bg-primary w-full" onClick={sendResetPasswordLink}>
              SEND RESET PASSWORD LINK
            </button>
            <h1 onClick={() => setShowForgotPassword(false)} className="cursor-pointer underline text-md text-primary text-left">
              Click Here To Login
            </h1>
          </div>
        </div>
